...
You will be provided with a function signature and a docstring. Your task is to write the body of the function that adheres to the provided signature and fulfills the functionality described in the docstring. Only write the body of the function, do not include the function signature or any other extra text."""
