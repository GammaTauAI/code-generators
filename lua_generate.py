...
LUA_SIMPLE_CHAT_INSTRUCTION = f"""{LUA_EXPERT_PREFIX}
You will be provided with a function signature and a comment explaining what the function should do. Your task is to write the body of the function that adheres to the provided signature and fulfills the functionality described in the docstring. Only write the body of the function, do not include the function signature or any other extra text."""
...
class LuaGenerator(Generator):
    ...
    def func_impl(
        ...
        return generic_generate_func_impl(
            ...
            SIMPLE_CHAT_INSTRUCTION=LUA_SIMPLE_CHAT_INSTRUCTION,
            REFLEXION_COMPLETION_INSTRUCTION=RS_REFLEXION_COMPLETION_INSTRUCTION,
            SIMPLE_COMPLETION_INSTRUCTION=LUA_SIMPLE_COMPLETION_INSTRUCTION,
            REFLEXION_FEW_SHOT=RS_REFLEXION_FEW_SHOT_ADD,
            fix_body=lua_fix_body,
        )
